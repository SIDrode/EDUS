    ...
    <!-- Fine Gestione errori con alert -->
      	<div class="row">
  			<div class="col-md-6 col-md-offset-3">
				...
				<br>
				<div align="center"><img src="img\edus-login.png" align="center" class="img-fluid"></div>
				<br>
  					...
  					<div class="panel-body">
  						<div class="row">
  							<div class="col-lg-12">
  								<form id="login-user-form" action="php/authenticationLDAP.php" method="post" role="form" style="display: block;">
  									...
  									<div class="form-group text-center">
  										<input type="checkbox" tabindex="3" class="" name="remember" id="remember_me" value="remeber-me">
  								...
  								<form id="login-tutor-form" action="php/tutor_login.php" method="post" role="form" style="display: none;">
  									<div class="form-group">
  										<input type="text" name="tutor-username" id="tutor-username" tabindex="1" class="form-control" placeholder="Username" value="">
  									</div>
  									<div class="form-group">
  										<input type="password" name="tutor-password" id="tutor-password" tabindex="2" class="form-control" placeholder="Password">
  									</div>
									<div class="form-group text-center">
